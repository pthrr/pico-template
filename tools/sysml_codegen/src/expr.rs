//! Expression string helpers — trusted boundary.
//!
//! Pure string manipulation for converting SysML expressions to Rust.
//! All functions are `#[verifier::external_body]` since they use
//! `str::find`, `str::replace`, indexing, and `str::parse` which Verus
//! cannot reason about.
