...
mod tests {
    ...
    #[test]
    fn test_maintenance_actor_init(_state: &mut ()) {
    ...
    #[test]
    fn test_control_actor_init(_state: &mut ()) {
    ...
    #[test]
    fn test_button_actor_step(_state: &mut ()) {
    ...
    #[test]
    fn test_maintenance_actor_step(_state: &mut ()) {
