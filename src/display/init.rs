...
/// Initialize display for RP2040/RP2350 platforms.
///
...
pub fn init_display_rp<SPI, DC, RST, DELAY>(
    spi: SPI,
    dc: DC,
    mut rst: RST,
...
/// Initialize display for STM32U585 (Arduino UNO Q) platform.
///
/// Panics on init failure (hardware fault).
#[cfg(feature = "unoq")]
pub fn init_display_stm32<SPI, DC, RST, DELAY>(
    spi: SPI,
    dc: DC,
    mut rst: RST,
    buffer: &'static mut [u8],
